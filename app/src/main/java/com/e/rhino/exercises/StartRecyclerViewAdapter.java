...
import com.e.rhino.exercises.StartFragment.OnListFragmentInteractionListener;
...
public class StartRecyclerViewAdapter extends RecyclerView.Adapter<StartRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mContentView.setText(mValues.get(position).questions.size() + " phrases");
        //holder.mImageView.setImageBitmap(Tools.getThumbnail(holder.mView.getResources(), id, 100, 100));
